...
export default function Burger() {
    ...
    const openMenu = () => {
        ...
        document.querySelector("#Header > .headerInferior-2 > div.links").classList.add("active");
    }
    ...
    const closeMenu = () => {
        ...
        document.querySelector("#Header > .headerInferior-2 > div.links").classList.remove("active");
    }
