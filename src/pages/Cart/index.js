      ...
      <div className="cart-container">
        <div className="cart-content">
          ...
          <div className="total-price">
            <h3>
              Valor total:
              <span>{new Intl.NumberFormat('br-PT', { style: 'currency', currency: 'BRL' }).format(precoTotal)}</span>
            </h3>
            <h3>
              Valor total anterior ao desconto:
              <span>{new Intl.NumberFormat('br-PT', { style: 'currency', currency: 'BRL' }).format(totalPriceWODiscount)}</span>
            </h3>
          </div>
