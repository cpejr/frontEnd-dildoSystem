          ...
          <div className="about-container">
            <div className="justified-about-container">
              ...
              <div className="about-paragraph">
                <h3>Como comprar</h3>
                <p>
                  Como comprar na Casulus? É muito fácil! <br></br><br></br>
                  Primeiro clique em 
                  “cadastrar”
                  e preencha com os seus dados. <br></br><br></br>
                  Depois de efetuar o cadastro, você já está pronto para começar as suas compras.<br></br><br></br>
                  ...
                  buscar o produto na loja.<br></br><br></br>
                  Efetue o pagamento, e se preferir pode nos mandar o comprovante de pagamento pelo 
                  e-mail ou WhatsApp para agilizarmos seu pedido.<br></br><br></br>
                  Os produtos, só serão separados mediante a confirmação pagamento. Após a separação, 
                  seu pedido será devidamente embalado para envio ou retirada.<br></br><br></br>
