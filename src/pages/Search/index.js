      ...
      <div className="searchpage-content">
        ...
        <div className="background">
          <div className="wrapper-background-1">
            <img src={borboletaAmarela2} className="background-img2" alt="borboletas" />
            <img src={borboletaAmarela1} className="background-img1" alt="borboletas" />
          </div>
          <div className="wrapper-background-2">
            <img src={borboletaAmarela1} className="background-img4" alt="borboletas" />
            <img src={borboletaAmarela2} className="background-img3" alt="borboletas" />
          </div>
