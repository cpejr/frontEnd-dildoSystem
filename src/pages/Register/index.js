...
import {
  TextField, MenuItem, Button, FormControlLabel, Checkbox,
...
const Register = function () {
  ...
  function validateFields() {
    ...
    if (!validateEmpty(name, setNameError, nameError)) return false;
    ...
    if (!validateEmpty(type, setTypeError, typeError)) return false;
            ...
            <div className="d-flex flex-column w-100 h-100">
              ...
              <FormControlLabel
                ...
                label={(
                    <div>
                        <span>Aceito os </span>
                        <Link to="/conditions" target="_blank">termos de uso</Link>
                        <span> e a </span>
                        <Link to="/conditions" target="_blank">política de privacidade</Link>
                      </div>
)}
                labelPlacement="end"
              />
